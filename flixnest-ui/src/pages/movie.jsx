...
export default function Movie() {
  ...
  const genresLoaded = useSelector((state) => state.flixnest.genresLoaded);
  const movies = useSelector((state) => state.flixnest.movies);
  const genres = useSelector((state) => state.flixnest.genres);
  ...
  return (
    ...
    <div className="hero">
      <img src={backgroundImage} alt="backround_Image" className="background-imgae" />
